...
<?php include './mvc/Views/masterlayout.php'; ?>
    ...
    <section id="section-main">
        <section class="card">
            <h3 class="title-about">Thành viên tham gia</h3>
            ...
            <div class="card__container bd-container">
                <div class="card__glass">
                    <img src="./public/images/img2.jpg" alt="" class="card__img">

                    <div class="card__data">
                        <h3 class="card__title">Nguyễn Tấn Vũ</h3>
                ...
                <div class="card__glass">
                    ...
                    <div class="card__data">
                        <h3 class="card__title">Vũ Đình Quang Minh</h3>
                ...
                <div class="card__glass">
                    <img src="./public/images/img3.jpg" alt="" class="card__img">

                    <div class="card__data">
                        <h3 class="card__title">Phùng Duy Phước</h3>
                ...
                <div class="card__glass">
                    <img src="./public/images/img1.jpg" alt="" class="card__img">

                    <div class="card__data">
                        <h3 class="card__title">Nguyễn Lê Kim Khánh</h3>
                        <span class="card__profession">Ui/Ux Design</span>
                    </div>
                ...
                <div class="card__glass">
                    ...
                    <div class="card__data">
                        <h3 class="card__title">Dư Thị Như Quỳnh</h3>
                        <span class="card__profession">Ui/Ux Design</span>
                    </div>
