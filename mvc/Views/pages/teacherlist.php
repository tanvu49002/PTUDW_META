...
<head>
    ...
    <link rel="stylesheet" href="./public/style/teacherlist2.css">
    <style>
        ...
        <main class="table">
            <section class="table__header">
                ...
                <form class="input-group" style="margin-left: 40%;" action="" method="post">
                    ...
                    <input class="app10001" type="submit" value="Tìm kiếm" style="border-radius: 20px;padding: 8px;background: linear-gradient(130deg, rgba(251, 251, 254, .9), rgba(251, 251, 254, .2));border: none; cursor: pointer;" name="SearchTeacher-submit">
                </form>
